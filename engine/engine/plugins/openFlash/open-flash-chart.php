...
function _ofc( $width, $height, $url, $use_swfobject, $base )
{
    ...
    //$out[] = '<script type="text/javascript" src="'. $base .'/images/ofc.js"></script>';
    
    if( !isset( $open_flash_chart_seqno ) )
    {
        $open_flash_chart_seqno = 1;
        $out[] = '<script type="text/javascript" src="'. $base .'/images/swfobject.js"></script>';
    }
    else
    {
...
$x = open_flash_chart_object( 300,300,"/images/open-flash-chart.swf", true);
...
var so = new SWFObject("/images/open-flash-chart.swf", "ofc", "250", "200", "9", "#FFFFFF");
