<?php
  ...
  //$obj = new XmlForm_Field_TextPM ($dbc);
  $t   = new lime_test( 42, new lime_output_color() );

  $className = XmlForm_Field_TextPM;
  ...
  $t->is ( $aMethods[1],      'renderGrid',   'renderGrid() is callable' );

  //$result = $obj->renderGrid ( $values, $owner);
  //$t->isa_ok( $result,      'NULL',   'call to method renderGrid ');
  $t->todo( "call to method renderGrid using $values, $owner ");


  //checking method 'attachEvents'
  $t->is ( $aMethods[2],      'attachEvents',   'attachEvents() is callable' );

  //$result = $obj->attachEvents ( $element);
  //$t->isa_ok( $result,      'NULL',   'call to method attachEvents ');
  $t->todo( "call to method attachEvents using $element ");


  //checking method 'XmlForm_Field'
  $t->is ( $aMethods[3],      'XmlForm_Field',   'XmlForm_Field() is callable' );
  ...
  $t->is ( $aMethods[4],      'validateValue',   'validateValue() is callable' );
  ...
  $t->is ( $aMethods[5],      'executeXmlDB',   'executeXmlDB() is callable' );
  ...
  $t->is ( $aMethods[6],      'executePropel',   'executePropel() is callable' );
  ...
  $t->is ( $aMethods[7],      'executeSQL',   'executeSQL() is callable' );
  ...
  $t->is ( $aMethods[8],      'htmlentities',   'htmlentities() is callable' );
  ...
  $t->is ( $aMethods[9],      'renderTable',   'renderTable() is callable' );
  ...
  $t->is ( $aMethods[10],      'dependentOf',   'dependentOf() is callable' );
 ...
 $t->is ( $aMethods[11],      'mask',   'mask() is callable' );
  ...
  $t->is ( $aMethods[12],      'getAttributes',   'getAttributes() is callable' );
  ...
  $t->is ( $aMethods[13],      'getEvents',   'getEvents() is callable' );
